...
import (
	...
	extensions "github.com/gocolly/colly/v2/extensions"
...
func Init(appsJSONPath, proxyURI string, JSON bool) (wapp *Wappalyzer, err error) {
	wapp = &Wappalyzer{}
	...
	if proxyURI != "" {
		...
		if err != nil {
			log.Errorf("Couldn't open parse proxy uri: %s\n", proxyURI)
			return nil, err
		}
		wapp.Transport.Proxy = http.ProxyURL(proxyURL)
	}
